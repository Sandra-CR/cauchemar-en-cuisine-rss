...
export const RSS_SOURCE_URL = 'https://www.coulisses-tv.fr/index.php/component/k2/itemlist/category/14-divertissements?format=feed&type=rss';
...
export class RssSourceError extends Error {
	constructor(
		message: string,
...
export async function fetchRssSource(sourceUrl = RSS_SOURCE_URL): Promise<string> {
...
export function createEpisodeArticleId(article: Pick<EpisodeArticle, 'guid' | 'link'>): string {
...
export function parseEpisodeArticles(rss: string): EpisodeArticle[] {
